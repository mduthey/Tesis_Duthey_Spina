...
public class Main extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ar/edu/unicen/haxe/main";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        try {
            ...
            //File file = new File(getClass().getClassLoader().getResource("/ar/edu/unicen/haxe/model/haxe.ecore").getFile());
            
            File file = null;
            String resource = "/ar/edu/unicen/haxe/model/haxe.ecore";
            ...
            resourceSet.getPackageRegistry().put("http://haxe.unicen.edu.ar", obj);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
